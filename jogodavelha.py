...
# Verificando se o jogador marcou uma coordenada já marcada pelo outro jogador
...
# Como pedido no item 5 do trabalho, a função mostra ao jogador da vez (caso o outro jogador
# esteja na iminência de ganhar) que ele não pode evitar
